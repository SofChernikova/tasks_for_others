package com.company.Solomatin.interfaces;
...
public interface BSTreeMap<K extends Comparable<? super K>, V> extends ru.vsu.cs.util.dummy.DefaultNotSupportedSortedMap<K, V> {
    ...
    default Set<K> keySet() {
        return new ru.vsu.cs.util.dummy.DefaultNotSupportedSet<K>() {
    ...
    default Collection<V> values() {
        return new ru.vsu.cs.util.dummy.DefaultNotSupportedCollection<V>() {
            Iterator<Map.Entry<K, V>> entryIterator = entrySet().iterator();
    ...
    default Set<Map.Entry<K, V>> entrySet() {
        return new ru.vsu.cs.util.dummy.DefaultNotSupportedSet<Entry<K, V>>() {
            @Override
            public int size() {
                return BSTreeMap.this.size();
            }
