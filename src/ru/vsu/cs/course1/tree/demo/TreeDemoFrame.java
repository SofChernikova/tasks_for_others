    ...
    public TreeDemoFrame() {
        ...
        buttonPreOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                ...
                */
                System.out.println();
                System.out.println("Элементов слева:" + " " + BinaryTreeAlgorithms.returnLeftcounter());
                System.out.println("Элементов справа:" + " " + BinaryTreeAlgorithms.returnAllNodeCounter());
        ...
        buttonInOrderTraverse.addActionListener(actionEvent -> {
            showSystemOut(() -> {
               // System.out.println("Посетитель:");
                BinaryTreeAlgorithms.NodeCounts counts = BinaryTreeAlgorithms.getLeftNodes(tree.getRoot());
                System.out.println();
                System.out.println("Элементов cлева:" + " " + counts.leftNodes);
                int tmp = counts.rightNodes - 1;
                System.out.println("Элементов справа:" + " " + tmp);
