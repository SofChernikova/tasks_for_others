...
public interface BSTreeMap<K extends Comparable<? super K>, V> extends DefaultNotSupportedSortedMap<K, V> {
    ...
    //конструируем новый объект - ключ+значение - и сравнение происходит только по ключу (поэтому null в качестве
    // 2го параметра, нам оно не важно)
    ...
    @Override
    //мы создаем новый объект - ключ+значение - и кладём его в дерево, возвращаем значениеыы
